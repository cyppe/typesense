...
NuRaftStateLayout NuRaftStateLayout::from_state_dir(const std::string& state_dir) {
    ...
    layout.applied_requests_file = join_path(layout.meta_dir, "applied_requests.jsonl");
    layout.active_log_segment_file = join_path(layout.log_dir, "segment-0000000000000001.log");
