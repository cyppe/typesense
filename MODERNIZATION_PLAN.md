...
- The recommended low-risk bugfix subset is now landed. The remaining tracked `upstream/v31` deltas (`fb5bf14b` patch-keys support and `eb81162a` dynamic faceting) are larger product-surface changes that need explicit accept/defer decisions rather than automatic parity backports.
