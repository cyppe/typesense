...
- **Active now:** item **26** (`ORT external Abseil injection and upgrade unblock`) is the recommended next lane. Items **27** through **33** are investigation-first follow-ups queued behind it in priority order.
