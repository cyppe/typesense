...
protected:
    ...
    virtual void SetUp() {
        state_dir_path = typesense_test::make_test_temp_dir("curation_index_manager");
...
TEST_F(CurationIndexManagerTest, ListOverrideItems) {
    ...
    ASSERT_EQ(404u, list_missing.code());
...
TEST_F(CurationIndexManagerTest, BasicSetItemOperations) {
    ...
    ASSERT_EQ(404u, del_missing.code());
...
TEST_F(CurationIndexManagerTest, BasicSetOperations) {
    ...
    ASSERT_EQ(size_t{2}, all_sets.size());
    ...
    ASSERT_EQ(size_t{1}, all_sets_after.size());
    ...
    ASSERT_EQ(404u, rem_missing.code());
...
TEST_F(CurationIndexManagerTest, UpsertSet) {
    ...
    ASSERT_EQ(size_t{2}, list1.get().size());
    ...
    ASSERT_EQ(size_t{1}, list2.get().size());
...
TEST_F(CurationIndexManagerTest, ListSetItems) {
    ...
    ASSERT_EQ(size_t{2}, list_mid.get().size());
    ...
    ASSERT_EQ(404u, list_missing_set.code());
...
TEST_F(CurationIndexManagerTest, UpsertSetItem) {
    ...
    ASSERT_EQ(size_t{1}, get_item.get()["includes"].size());
