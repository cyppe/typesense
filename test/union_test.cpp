...
TEST_F(UnionTest, UnionHighlightingUAFRaceASAN) {
    ...
    ASSERT_GT(union_calls.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(mutation_batches.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(total_mutations.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(total_mutations_during_search.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(union_hit_count.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(union_nonempty_highlight_count.load(std::memory_order_relaxed), size_t{0});
    ASSERT_GT(union_title_highlight_count.load(std::memory_order_relaxed), size_t{0});
}
