...
struct CollectionImportMetricsSnapshot {
    ...
    uint64_t last_async_reference_helper_chunks = 0;
...
//for hybrid search, compute text_match_score for only vector search results and vector_distance for only text_match results
    ...
    collection_search_args_t(std::string raw_query, std::vector<std::string> search_fields, std::string filter_query,
                             ...
                             size_t facet_sample_percent, size_t facet_sample_threshold, size_t facet_sample_slope, float facet_min_occurrence_ratio, size_t offset,
            ...
            facet_sample_percent(facet_sample_percent), facet_sample_threshold(facet_sample_threshold), facet_sample_slope(facet_sample_slope), facet_min_occurrence_ratio(facet_min_occurrence_ratio), offset(offset),
...
private:
    ...
    static Option<bool> filter_dynamic_facets_by_occurrence(nlohmann::json& facet_counts, size_t found_docs, float facet_min_occurrence_ratio);
