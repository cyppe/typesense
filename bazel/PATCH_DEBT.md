...
2. For each `upstream candidate`, open/track upstream reference and record link in this file. Current tracked links: `apache/brpc#2904`, `baidu/braft#237`, `baidu/braft#524`, `baidu/braft#517`; `0006_cxx20_shuffle.patch` still has no exact upstream issue.
